class Config(object):
    ...
    DATABASE_URL = "postgres://iduyuzwt:OP3vNRUi5JHefpgToeeM0HYWAE5lhjNF@mahmud.db.elephantsql.com/iduyuzw"  # A sql database url from elephantsql.com
    ...
    DEMONS = [5057623667]  # User id of support users
    TIGERS = [6246358451]  # User id of tiger users
    WOLVES = [5149937796]  # User id of whitelist users
